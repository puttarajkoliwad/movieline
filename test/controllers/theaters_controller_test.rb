...
class TheatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post theaters_url, params: { theater: { location: @theater.location, name: @theater.name, price: @theater.price } }
    end
  ...
  test "should update theater" do
    patch theater_url(@theater), params: { theater: { location: @theater.location, name: @theater.name, price: @theater.price } }
